...
public class DedicationTokens {
	...
	public void initializeDedicationComponents(){
		...
		dedicationComponent_4[1] = new Tokens(7,0);
		dedicationComponent_4[2] = new Tokens(7,4);
		...
		dedicationComponent_4[7] = new Tokens(4,0);
		dedicationComponent_4[8] = new Tokens(3,0);
		...
		dedicationComponent_6[1] = new Tokens(8,0);
		dedicationComponent_6[2] = new Tokens(8,4);
		dedicationComponent_6[3] = new Tokens(7,0);
		dedicationComponent_6[4] = new Tokens(7,3);
		dedicationComponent_6[5] = new Tokens(6,0);
		dedicationComponent_6[6] = new Tokens(6,3);
		dedicationComponent_6[7] = new Tokens(5,0);
		dedicationComponent_6[8] = new Tokens(4,0);
		...
		dedicationComponent_7[2] = new Tokens(9,4);
		dedicationComponent_7[3] = new Tokens(8,0);
		dedicationComponent_7[4] = new Tokens(8,3);
		dedicationComponent_7[5] = new Tokens(7,0);
		dedicationComponent_7[6] = new Tokens(7,3);
		...
		dedicationComponent_extra[1] = new Tokens(3,0);
		dedicationComponent_extra[2] = new Tokens(3,4);
	}
